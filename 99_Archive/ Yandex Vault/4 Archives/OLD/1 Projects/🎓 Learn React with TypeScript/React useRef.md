...
```
A common use of the `useRef` Hook is to access [[HTML and CSS|HTML]] elements imperatively. HTML elements have a `ref` attribute in [[JSX]] that can be assigned to a `ref`. The following is an example of this:
```typescript
