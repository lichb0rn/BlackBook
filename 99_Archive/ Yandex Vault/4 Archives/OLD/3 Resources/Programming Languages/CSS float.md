...
# [[CSS float]]
By default, content is displayed in the page in the order it appears within the [[HTML and CSS|css| HTML]] file as part of the normal document flow. Floating an element takes it out of position and places it along the left or right edge of its parent element. Subsequent content that is not floated occupies the space previously taken up by the floated element. 
