...
Куча оптимизирована на выдачу минимального или максимального элемента.
В случае кучи на массивах, при индексации массива с $0$ доступ к левому и правому потомку:
- левый: $2i +1$
- правый: $2i+2$
