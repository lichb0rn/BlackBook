...
If your main font is a web font, it’s a good idea to request the file upfront by loading it with a link in the head section of your [[064 HTML and CSS|HTML]] with the `rel` attribute value as preload:
```html
<link
    rel="preload"
